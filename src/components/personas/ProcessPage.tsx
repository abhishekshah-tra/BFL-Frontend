...
const PROC_LAST_UPDATED = new Date('2025-05-20T10:30:00+04:00')

const WAREHOUSES: WarehouseId[] = ['TECHNO', 'YOTO', 'JAFZA']
const PROCESSES: { value: ProcessName; label: string }[] = [
...
function isProcess(value: string | null): value is ProcessName {
...
function ProcessContent() {
  ...
  const [process, setProcess] = useState<ProcessName>(() => {
    const p = searchParams?.get('process') ?? null
  ...
  return (
    <div id="page-process" className="page-view active">
          ...
          <div className="proc-filter-group">
            <div className="filter-label-wrap">
              ...
              <select
                ...
                value={warehouse}
                onChange={(e) => {
                  setWarehouse(e.target.value as WarehouseId)
            ...
            <div className="filter-label-wrap">
              ...
              <select
                ...
                value={process}
                onChange={(e) => {
                  const next = e.target.value as ProcessName
                  setProcess(next)
      ...
      <div className="bottom-grid-2">
        <div className="widget-card affected-card">
          ...
          <span
            ...
            tabIndex={0}
            onClick={() =>
              showToast('Opening Item Journey for 125 affected journeys (4,860 units)')
            }
          >
            View Item Journey →
          </span>
